        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="mb-3">
                    ...
                    <a href="{{ url('kategori-items/' . $kategori->id . '/export-pdf') }}" class="btn btn-danger">Download
                        PDF</a>
                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-bordered">
                                ...
                                <tbody>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="4" class="text-center text-muted">Belum ada item untuk kategori ini.
                                            </td>
                                        </tr>
                                    @endforelse
                                </tbody>
