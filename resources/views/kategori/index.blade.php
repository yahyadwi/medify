    ...
    <div class="container">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="{{ url('kategori-items') }}" method="GET" class="row g-3">
                    <div class="col-md-4">
                        <input type="text" name="nama_kategori" class="form-control" placeholder="Filter Nama..."
                            value="{{ request('nama_kategori') }}">
                    </div>
                    <div class="col-md-4">
                        <input type="text" name="kode_kategori" class="form-control" placeholder="Filter Kode..."
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                ...
                <button class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#modalTambah">Tambah
                    Kategori</button>
            </div>
            <div class="card-body">
